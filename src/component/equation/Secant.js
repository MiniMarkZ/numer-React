  ...
  return (
          <Container>
              ...
              <div className="wrapper" >
                  ...
                  <div className="container1">
                      <Form>
                          ...
                          <Form.Group className='mb-3'>
                              ...
                              <Form.Control type="number" id="XR" value={x1} onChange={inputX1}  />
                  ...
                  <h4 style={{textAlignVertical: "center",textAlign: "center",}}>Secant Chart</h4>
                  ...
                  {noData && <Myline2 Iteration={valueIter} X= {valueXNew}  name={"Secant"} Error={valueEa} />}
                  </div>
              </div>
